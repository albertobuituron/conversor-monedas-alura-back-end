...
public class Calculos {
    ...
    public void almacenarValoresPersonalizados(){
        ...
        System.out.println("Ingrese la moneda base (3 letras del código de moneda)");
        this.monedaBase = lectura.next();
        System.out.println("Ingrese la moneda a la que desea obtener el resultado (3 letras del código de moneda)");
    ...
    public String obtenerMensajeRespuesta() {
        String mensaje = "El importe de " + getMonedaBase().toUpperCase() + " " + getCantidad() + " equivale a " + getMonedaObjetivo().toUpperCase() + " " + conversion.buscaConversion(getMonedaBase(), getMonedaObjetivo(), getCantidad());
